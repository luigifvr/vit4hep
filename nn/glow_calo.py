...
class GLOWCaloCouplingBlock(BaseCaloCouplingBlock):
    ...
    def __init__(self, dims_in, dims_c=[],
        ...
        self.subnet1 = subnet_constructor(self.split_len1 + self.split_len2, self.split_len3 * 2) # dims_in, dims_out
        self.subnet2 = subnet_constructor(self.split_len1 + self.split_len3, self.split_len2 * 2)
        self.subnet3 = subnet_constructor(self.split_len3 + self.split_len2, self.split_len1 * 2)
...
class GLOWCalo2CouplingBlock(BaseCalo2CouplingBlock):
    ...
    def __init__(self, dims_in, dims_c=[],
        ...
        # No length of conditions needed?
        self.subnet1 = subnet_constructor(self.split_len1, self.split_len2 * 2) # dims_in, dims_out
